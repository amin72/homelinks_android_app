...
class WebsiteFragment : Fragment() {
    ...
    private fun getLinks() {
        val call = AppController.apiInterface.links("websites", type=type)
    ...
    private fun getPaginatedLinks(page: Int, linkAdapter: LinkAdapter) {
        ...
        val call = AppController.apiInterface.links("websites", page, type)
    ...
    override fun onCreateOptionsMenu(menu: Menu, inflater: MenuInflater?) {
        ...
        menu.clear()
        inflater?.inflate(R.menu.website_list_menu, menu)
